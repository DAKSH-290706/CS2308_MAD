...
export default function App() {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {}
     <Image
        source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgeVP_xK3yqEDWNFAbbU9gEIpisMAreKqs3Q&s' }}
        style={styles.image}
      />

      {}
      <Text style={styles.name}>Daksh D</Text>
      ...
      <Text style={styles.text}>📧 dakshd@rvu.edu.in</Text>
      <Text style={styles.text}>📱 +91 7019512031</Text>
